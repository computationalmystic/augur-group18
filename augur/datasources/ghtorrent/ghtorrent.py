...
class GHTorrent(object):
    ...
    """
    USE CASE 1: Visualizing Openness of a Repo
    @annotate(tag='openness')
    def openness(self, owner, repo=None):
        Visualization of pull requests merged over pull requests proposed in a given time timeframe
        :param owner: :param owner: The name of the project owner or the id of the project in the projects table of the project in the projects table.
        :param repo: The name of the repo. Unneeded if repository id was passed as owner.
        :return: DataFrame with line for PRs merged and another for PRs proposed
    1) get the repoid
    2) get all pull requests proposed on the repo
    3) get all pull requests merged on the repo
    ...
    def openness(self, owner, repo=None):
        Finds the time since the last commit to the repo and determines whether the repo is inactive
        :param owner: :param owner: The name of the project owner or the id of the project in the projects table of the project in the projects table.
        :param repo: The name of the repo. Unneeded if repository id was passed as owner.
        :return: date of last commit to the repository
    1) get the repoid
    2) get the date of latest commit to that repo
    ...
    @annotate(tag='topcontributorsbycommit')
    def topcontributorsbycommit(self, owner, repo=None):
        Finds the time since the last commit to the repo and determines whether the repo is inactive
        :param owner: :param owner: The name of the project owner or the id of the project in the projects table of the project in the projects table.
        :param repo: The name of the repo. Unneeded if repository id was passed as owner.
        :return: DataFrame with list of the top authors by commit
    1) get the repoid
    2) get the contributions of all users who have contributed to this repo
